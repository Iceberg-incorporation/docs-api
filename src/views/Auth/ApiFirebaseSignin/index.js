...
export default function ApiFirebaseSigninView(props) {
    const [pathUrl] = React.useState(["blackboardapp.co", "auth", "firebase", "signin"])
    ...
    const [request] = React.useState({
        ...
        list: {
            HTTPrequest: {
                title: "HTTP request",
                detail: `POST https://api.blackboardapp.co/api/auth/blackbaord/firebase/signin`,
                option: {
                    method: 'POST',
                    path: `https://api.blackboardapp.co/api/auth/blackbaord/firebase/signin`
                }
            },
            headers: {
                title: "Headers",
